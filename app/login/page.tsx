  ...
  useEffect(() => {
    ...
    if (err) {
      const messages: Record<string, string> = {
        ...
        google_profile: "Failed to get Google profile info.",
        google_failed: "Google sign-in failed. Please try again.",
      };
      setError(messages[err] || "An error occurred with Google sign-in.");
    }
  }, [searchParams]);
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-[#faf7f2] via-white to-[#FFF8F0]">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button type="button" className="flex-1 flex items-center justify-center gap-3 border-2 border-gray-200 rounded-2xl py-3.5 text-sm font-medium text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200">
