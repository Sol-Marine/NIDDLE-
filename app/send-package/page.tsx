            ...
            <div className="flex border-b border-gray-100 overflow-x-auto">
              {steps.map((s, i) => (
                <button
                  ...
                  className={`flex-1 py-5 text-center text-sm font-semibold transition-all duration-300 relative min-w-0 ${
                    i === step
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm whitespace-nowrap">{s.label}</span>
                  {i < step && (
